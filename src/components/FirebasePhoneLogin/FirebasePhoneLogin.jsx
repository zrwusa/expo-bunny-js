        ...
        <View style={styles.contentPhone}>
            <InputCard title={st(`enterPhoneNumber`)}>
                <TextInputIcon
                    ...
                    autoCompleteType="tel" keyboardType="phone-pad" textContentType="telephoneNumber"
                    placeholder={t(`placeholders.phone`)} editable={!verificationId}
                    onChangeText={(phoneNumber) => setPhoneNumber(phoneNumber)} renderIcon={() => {
            ...
            <Row style={styles.recaptchaVerifierModal}>
                <FirebaseRecaptcha.FirebaseRecaptchaVerifierModal ref={recaptchaVerifier}
            ...
            <InputCard title={st(`enterVerificationCode`)}>
                <TextInputIcon ref={verificationCodeTextInput} editable={!!verificationId}
