...
export const LinearGradientButton = ({style, children, disabled, ...rest}) => {
    ...
    return <TouchableOpacity style={mergedStyle} disabled={disabled} {...rest}>
        <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 0}} style={LinearGradientButton.linearGradient}
                        colors={finalColors}>
            {children}
        </LinearGradient>
    </TouchableOpacity>;
...
export const TextInputIcon = React.forwardRef(({
    ...
    return (<View style={TextInputIcon.container}>
        ...
        <TextInputRN autoCapitalize={autoCapitalize} ref={ref} editable={editable}
                     placeholderTextColor={colors.placeholder} style={mergedStyle} {...rest}/>
    </View>);
});
