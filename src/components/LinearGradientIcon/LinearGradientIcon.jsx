...
export function LinearGradientIcon(props) {
    ...
    return (<View style={{width: finalSize, height: finalSize}} {...rest}>
        <MaskedView style={{flex: 1, flexDirection: 'row', width: finalSize, height: finalSize}}
            ...
            <LinearGradient locations={locations} start={start || startDefault} end={end || endDefault}
                            colors={colors || colorsDefault} style={{flex: 1}}/>
        </MaskedView>
    </View>);
}
