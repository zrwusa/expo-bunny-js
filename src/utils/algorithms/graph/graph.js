 ...
 * @param connections
 */
function criticalConnectionsByGraph(n, connections) {
    ...
    for (let bridge of bridges) {
        const vertexIds = bridge.vertices.map(v => v);
        ans.push(vertexIds);
    }
    return ans;
}
...
export async function regionsBySlashes(grid, proxyHandler) {
    // let graph;
    // if (proxyHandler) {
