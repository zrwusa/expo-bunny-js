...
import {DemoSvg} from '../../components';
import {shortenTFunctionKey} from '../../providers';
import {ScrollView} from 'react-native';
import {getContainerStyles, Row} from '../../containers';
import {DemoPureComponent, DemoRegularComponent} from '../../components';
...
function DemoCollectionScreen() {
    ...
    return (<ScrollView>
        <View style={[containerStyles.Screen, styles.container]}>
            ...
            <Row paddingVertical="l">
                <View style={containerStyles.Card}>
                    <DemoCCClock title={st(`classComponent`)} tipLabel={st(`tipLabel`)} goButtonTitle={st(`go`)}
                                 stopButtonTitle={st(`stop`)}/>
                </View>
            </Row>
            <Row paddingVertical="l">
                <View style={containerStyles.Card}>
                    <DemoRegularComponent title={st(`iAmRegular`)} labelBeenRendered={st(`iHaveBeenRendered`)}
                                          labelRenderedUnit={st(`renderedUnit`)}/>
                </View>
            </Row>
            <Row paddingVertical="l">
                <View style={containerStyles.Card}>
                    <DemoPureComponent title={st(`iAmPure`)} labelBeenRendered={st(`iHaveBeenRendered`)}
                                       labelRenderedUnit={st(`renderedUnit`)}/>
                </View>
            </Row>
            <Row paddingVertical="l">
