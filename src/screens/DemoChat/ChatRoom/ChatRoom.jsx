...
import {BunnyChat} from '../../../components';
...
export function ChatRoomScreen({route, navigation}) {
    ...
    const chatMessages = useSelector((state) => state.firestoreState.ordered.chatMessages);
    ...
    const generateMessage = (type, payload, needMerge) => {
