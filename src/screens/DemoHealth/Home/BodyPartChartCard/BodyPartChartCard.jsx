...
export function BodyPartChartCard(props) {
    ...
    return <View style={styles.bodyPartChartCard}>
        ...
        <Row>
            <VictoryChart width={wp(326)} height={160} theme={victory}
                ...
                <VictoryAxis dependentAxis axisLabelComponent={<VictoryLabel dy={wp(-26)} dx={wp(-10)}/>}
                             label="Max Weight (kgs)" tickCount={4} style={{
                    grid: {stroke: 'none'},
                    ticks: {stroke: 'none'},
                    axis: {stroke: 'none'},
                }}/>
