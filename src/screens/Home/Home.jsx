    ...
    return (<ScrollView>
        <View style={[containerStyles.Screen, styles.container]}>
            ...
            <Card titleMode="OUT" title={st(`navAndRoute`)}>
                ...
                <InlineJump type="LINK" iconName="profile-male" text={st(`profile`) + `(LinkButton)`} to="/profile/001"
                            iconSize={wp(20)}/>
                <Divider/>
                ...
                <InlineJump type="NAV" onNav={() => navigation.navigate('Profile', {id: '003'})} iconName="profile-male"
                            iconSize={wp(20)} text={st(`profile`) + '(TouchableOpacity)'}/>
                <Divider/>
                ...
                <InlineJump type="LINK" iconName="adjustments" text={st(`route`) + `(Link)`}
                            to="/demo-route?id=1&isHuman=false&sort=top" iconSize={wp(20)}/>
                <Divider/>
