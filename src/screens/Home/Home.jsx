    ...
    return (<ScrollView>
            <View style={[containerStyles.Screen, styles.container]}>
                ...
                <Card titleMode="OUT" title={st(`navAndRoute`)}>
                    ...
                    <InlineJump type="NAV" onNav={() => navigation.navigate('Profile', { id: '003' })} iconName="profile-male" iconSize={wp(20)} text={st(`profile`) + '(TouchableOpacity)'}/>
                    <Divider />
            ...
            isHuman: false,
            sort: 'top'
        })} iconName="adjustments" text={st(`route`) + '(TouchableOpacity)'} iconSize={wp(20)}/>
                    <Divider />
                    <InlineJump type="LINK" iconName="adjustments" text={st(`route`) + `(Link)`} to="/demo-route?id=1&isHuman=false&sort=top" iconSize={wp(20)}/>
                    <Divider />
                    ...
                    <InlineJump type="NAV" onNav={() => navigation.navigate('DemoNestedLv0', {
            ...
            params: {
                ...
                params: {
                    ...
                    <Divider />
                    <InlineJump type="LINK" iconName="greenkeeper" text={st(`passParamsFromRootToLeaf`) + `(Link)`} to="/demo-nested/settings/001/lv2-settings/002"/>
                    <Divider />
                    <InlineJump type="LINK" iconName="greenkeeper" text={st(`passParamsFromRootToLeafTab`) + `(Link)`} to="/demo-tab/settings/item-001"/>
                </Card>
