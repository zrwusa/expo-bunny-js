...
export function DemoSagaFirebaseScreen() {
    ...
    const todoList = useSelector((rootState) => rootState.firebaseState.ordered.todoList);
    ...
    return (<View style={[containerStyles.Screen, sharedStyles.centralizeHorizontal]}>
        <View style={styles.todoContainer}>
            ...
            <View style={styles.table}>
                ...
                {memorizedTodo && memorizedTodo.length > 0
                    ? <FlatList style={styles.flatList} data={todoList} renderItem={({item}) => {
