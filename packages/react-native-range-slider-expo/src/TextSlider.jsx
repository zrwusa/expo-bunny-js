...
const step = 1;
const min = 0;
const TextualSlider = ({ values, valueOnChange, styleSize = 'medium', knobColor = '#00a2ff', inRangeBarColor = 'rgb(200,200,200)', outOfRangeBarColor = 'rgb(100,100,100)', valueLabelsTextColor = 'white', valueLabelsBackgroundColor = '#3a4766', rangeLabelsStyle, showRangeLabels = true, showValueLabels = true, initialValue }) => {
    // settings
    ...
    const setValueText = (totalOffset) => {
        const numericValue = Math.floor(((totalOffset + (knobSize / 2)) * (max - min) / TextualSliderWidth) / step) * step + min;
