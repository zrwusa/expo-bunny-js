...
export const Slider = (props) => {
    ...
    const { min, max, valueOnChange, step = 1, styleSize = 'medium', knobColor = colors.primary, inRangeBarColor = colors.primary, outOfRangeBarColor = colors.divider, valueLabelsTextColor = colors.text2, valueLabelsBackgroundColor = '#3a4766', rangeLabelsTextColor = 'rgb(60,60,60)', showRangeLabels = true, showValueLabels = true, initialValue, valueLabelsPosition = 'down', showBubbles = false, showValueLabelsOnlyWhenDrag = false, valueLabelsUnit = '', invert = false, valueOnIndicated, } = props;
    // settings
    ...
    // refs
    const valueTextRef = React.createRef();
    ...
    const setValueStatic = (newOffset, knobSize, stepInPixels) => {
